...
map.getView().fit([-13191126.537425, 4031052.226566, -13159403.017164, 4046021.414028], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Los Angeles Marathon Course</h2>';
        return titleElement;
    })(),
